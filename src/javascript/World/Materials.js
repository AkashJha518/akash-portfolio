...
export default class Materials {
    ...
    setPures() {
        ...
        this.pures.items.yellow = new THREE.MeshBasicMaterial({ color: 0xADD8E6 });// New: Light Blue hex (0x prefix)
    ...
    setShades() {
        ...
        this.shades.items.myCustom.uniforms.matcap.value = this.resources.items.matcapWhiteTexture;
        this.items.myCustom = this.shades.items.myCustom; // Add to main items list

        // White
        this.shades.items.white = new MatcapMaterial()
        this.shades.items.white.name = 'shadeWhite'
        this.shades.items.white.uniforms.matcap.value = this.resources.items.matcapGrayTexture
        ...
        this.shades.items.orange.uniforms.matcap.value = this.resources.items.matcapEmeraldGreenTexture;
        ...
        this.shades.items.green.uniforms.matcap.value = this.resources.items.matcapEmeraldGreenTexture
        ...
        this.shades.items.gray.uniforms.matcap.value = this.resources.items.matcapWhiteTexture
        this.items.gray = this.shades.items.gray

        // Beige
        this.shades.items.beige = new MatcapMaterial()
        this.shades.items.beige.name = 'shadeBeige'
        this.shades.items.beige.uniforms.matcap.value = this.resources.items.matcapBrownTexture
    ...
    setFloorShadow() {
        ...
        this.items.floorShadow.shadowColor = '#1A3A3F';
