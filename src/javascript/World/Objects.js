...
export default class Objects {
    ...
    setParsers() {
        ...
        this.parsers.items = [
            ...
            {
                regex: /^shadeBlue_carBody/i, // Example: Match only the car body
                apply: (_mesh, _options) => {
                    const mesh = _options.duplicated ? _mesh.clone() : _mesh;
                    // Use MeshStandardMaterial for lighting or MeshBasicMaterial for flat color
                    mesh.material = new THREE.MeshStandardMaterial({
                        color: '#YOUR_HEX_CODE', // e.g., '#8A2BE2' for blue-violet
                        roughness: 0.7, // Adjust appearance
                        metalness: 0.1  // Adjust appearance
                    });
                    // Or: mesh.material = new THREE.MeshBasicMaterial({ color: '#YOUR_HEX_CODE' });
                    return mesh;
                }
            },
            // Shade
