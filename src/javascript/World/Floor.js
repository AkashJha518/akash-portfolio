...
export default class Floor {
    constructor(_options) {
        ...
        // Colors
        this.colors = {}
        this.colors.topLeft = '#3ce9f5';     // Changed from '#f5883c'
        this.colors.topRight = '#4198ff';     // Changed from '#ff9043'
        this.colors.bottomRight = '#92effc'; // Changed from '#fccf92'
        this.colors.bottomLeft = '#26dbaf';   // Changed from '#f5aa58'
        // Material
